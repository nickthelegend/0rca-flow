...
function StructuredOutputNode({ id, data, selected }: NodeProps<any>) {
  ...
  return (
    <div className="relative" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
      ...
      >
        <Card
          className={`min-w-[280px] border-2 bg-card transition-all ${selected ? "border-primary shadow-lg" : "border-border"
            }`}
        >
